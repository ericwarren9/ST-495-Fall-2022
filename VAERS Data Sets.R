...
filesData <- list.files("~/ST-495-Fall-2022/FinalProjectRawData/RegularData")

setwd("~/ST-495-Fall-2022/FinalProjectRawData/RegularData")
...
write_csv(finalVAERSData, "~/ST-495-Fall-2022/FinalProjectUsedData/2016-21VAERSData.csv") #Full data set

write_csv(finalVAERSData2016, "~/ST-495-Fall-2022/FinalProjectUsedData/2016VAERSData.csv") #2016 data set

write_csv(finalVAERSData2017, "~/ST-495-Fall-2022/FinalProjectUsedData/2017VAERSData.csv") #2017 data set

write_csv(finalVAERSData2018, "~/ST-495-Fall-2022/FinalProjectUsedData/2018VAERSData.csv") #2018 data set

write_csv(finalVAERSData2019, "~/ST-495-Fall-2022/FinalProjectUsedData/2019VAERSData.csv") #2019 data set

write_csv(finalVAERSData2020, "~/ST-495-Fall-2022/FinalProjectUsedData/2020VAERSData.csv") #2020 data set

write_csv(finalVAERSData2021, "~/ST-495-Fall-2022/FinalProjectUsedData/2021VAERSData.csv") #2021 data set
